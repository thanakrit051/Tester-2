...
const coreCss = [
  ":root{--bg:#f4f6f5;--ink:#131917;--ink2:#56635d;--ink3:#8b948f;--line:#e5e9e7;--accent:#0f7a43}",
  '@media(prefers-color-scheme:dark){:root:not([data-theme="light"]){--bg:#101211;--ink:#ecefed;--ink2:#a4ada8;--ink3:#79827d;--line:#2c2e2b;--accent:#2fa367}}',
  '[data-theme="dark"]{--bg:#101211;--ink:#ecefed;--ink2:#a4ada8;--ink3:#79827d;--line:#2c2e2b;--accent:#2fa367}',
  "html,body{margin:0;background:var(--bg);color:var(--ink);font-family:'IBM Plex Sans Thai',system-ui,sans-serif;line-height:1.55}",
  ...
  ".boot-mark{width:72px;height:72px;border-radius:22px;background:var(--accent);color:#fff;font-size:33px;font-weight:700;display:grid;place-content:center;position:relative}",
  ".boot-mark span{position:absolute;right:-7px;bottom:-7px;width:30px;height:30px;border-radius:50%;background:var(--bg);color:var(--accent);font-size:15px;display:grid;place-content:center}",
